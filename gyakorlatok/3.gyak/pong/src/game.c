    ...
    while (SDL_PollEvent(&event)) {
        ...
        case SDL_KEYDOWN:
            ...
            case SDL_SCANCODE_RIGHT:
                update_ball(&(game->pong.ball), 0.0, game->pong.ball.radius+10,game->pong.ball.rotation);
                break;
        ...
        case SDL_MOUSEMOTION:
            if(event.button.x >= game->pong.ball.x-game->pong.ball.radius && event.button.x <= game->pong.ball.x+game->pong.ball.radius &&
                event.button.y >= game->pong.ball.y-game->pong.ball.radius && event.button.y <= game->pong.ball.y+game->pong.ball.radius){
                    game->pong.ball.x = event.button.x;
                    game->pong.ball.y = event.button.y;
                    game->pong.ball.speed_x = 0;
                    game->pong.ball.speed_y = 0;
                    update_ball(&(game->pong.ball), 0.0, game->pong.ball.radius, game->pong.ball.rotation);
                }
            break;
